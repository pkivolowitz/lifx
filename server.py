...
_ROUTES: tuple[_Route, ...] = (
    ...
    _Route("POST", ("api", "registry", "subdevice"),
           "_handle_post_registry_subdevice"),
    ...
    _Route("DELETE", ("api", "registry", "device", "{mac}"),
           ...
           unquote_params=("mac",)),
    _Route("DELETE",
           ("api", "registry", "subdevice", "{parent_mac}", "{component_id}"),
           "_handle_delete_registry_subdevice",
           unquote_params=("parent_mac", "component_id")),
