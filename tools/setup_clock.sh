...
#
# Required:
#   server_ip           IP of the GlowUp server (e.g. 10.0.0.48)
#
# Options:
...
#
# Examples:
#   ./setup_clock.sh 10.0.0.48
#   ./setup_clock.sh 10.0.0.48 --hostname bedroom --rotate 90 --ble
#   ./setup_clock.sh 10.0.0.48 --reboot "Wed 03:00"
#
