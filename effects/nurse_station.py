...
COLOR_OFFLINE: HSBK = (hue_to_u16(220.0), HSBK_MAX, int(HSBK_MAX * 0.10), KELVIN_DEFAULT)
...
BREATHE_MAX_BRIGHTNESS: int = int(HSBK_MAX * 0.50)

# Brightness for solid critical (no pulse).
CRITICAL_BRIGHTNESS: int = int(HSBK_MAX * 0.60)
